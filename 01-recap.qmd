...
::: {.callout-important}
Ensure you select an appropriate folder to store your `GEOG0018` project. For example, you might use your *Methods in Human Geography* folder, if you have one, or another location within your `Documents` directory on your computer. You can select a location by clicking on **Browse**. If you are using iCloud Drive, avoid saving your project there, as syncing can sometimes cause issues. 
:::
...
::: {.callout-note}
You will have to create a folder named `data` inside your **RStudio Project**.
:::
