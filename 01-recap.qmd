...
## Installation of R
R is a programming language originally designed for conducting statistical analysis and creating graphics. The major advantage of using R is that it can be used on any computer operating system, and is free for anyone to use and contribute to. Because of this, it has rapidly become the statistical language of choice for many academics and has a large user community with people constantly contributing new packages to carry out all manner of statistical, graphical, and geographical tasks.
...
#| filename: "R code"
# install packages
install.packages(c('tidyverse', 'janitor', 'descr', 'ggcorrplot','easystats'))
```
...
Navigate to **File** -> **New Project** -> **New Directory**, and create a folder with the name `GEOG0018`. Click on **Create Project**. You should now see your main RStudio window switch to this new project and when you check your **files** pane, you should see a new **R Project** called `GEOG0018`.
