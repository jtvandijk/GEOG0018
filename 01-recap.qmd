...
To get started, let us create our first script. **File** -> **New File** -> **R Script**. Save your script as `w01-age-analysis.r`. 
...
We can also call some functions to quickly draw a boxplot, histogram, or, when combining different variables, a bivariate plot:
...
## Homework task 
This concludes this week's tutorial Please complete the following homework tasks:

1. Filter the LSOAs for a [London borough](https://en.wikipedia.org/wiki/London_boroughs) of your choice.
