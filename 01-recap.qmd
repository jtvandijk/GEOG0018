...
::: {.callout-tip}
In the event that you do not have access to a laptop or encounter issues with the installation process, RStudio is also available via [Desktop@UCL Anywhere](https://www.ucl.ac.uk/isd/services/computers/remote-access/desktopucl-anywhere) and can also be accessed on all UCL computers across campus.
:::
...
To get started, let us create our first script. **File** -> **New File** -> **R Script**. Create a folder named `scripts`, and save your script as `w01-age-analysis.r`. 
...
## Homework task 
This concludes our session. Please complete the following homework tasks:

1. Filter the LSOAs for a London borough of your choice.
...
::: {.callout-warning}
Make sure to copy and paste the output of your homework task (i.e. histogram or boxplot) into the appendix of your assignment.
:::
