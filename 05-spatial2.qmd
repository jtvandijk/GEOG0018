...
2. Within the toolbox, select the parameters as follows:
    ...
    - **Points:** `London-Crime-2021` [Note how both our data layers state the same CRS.]
...
4. Right-click on the `borough-London-Borough-Crime` layer and open the **Attribute Table**. If all went well, you should see a `theft2021` column next to your `pop2021` column.
