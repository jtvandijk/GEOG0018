# Spatial Analysis II
Building on last week's introduction to creating thematic maps, this week we take it a step further by conducting some basic spatial analysis. Still using QGIS( [QGIS](https://qgis.org/), we will focus on aggregating point event data to administrative geographies and then mapping the results.
