...
2.  If you use a Windows computer, click on *Download R for Windows*. Then click on *base*. Download and install **R 4.5.x for Windows**. If you use a Mac computer, click on *Download R for macOS* and download and install **R-4.5.x.arm64.pkg** for [Apple silicon Macs](https://support.apple.com/en-gb/HT211814) or **R-4.5.x.x86_64.pkg** for older [Intel-based Macs](https://support.apple.com/en-gb/HT211814).
