...
::: {.callout-important}
Since the $p$-value is `< 0.05` we can conclude reject the null hypothesis that means for Sutton and Camden are the same, and accept the alternative hypothesis.
:::
