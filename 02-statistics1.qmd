...
### Data manipulation
Since the `lsoa_emp` dataset was extracted using the [Custom Dataset Tool](https://www.ons.gov.uk/datasets/create), we need to convert the data from long to wide format. Like last week, we can do this by pivoting the table:
...
3. Include the test outputs in the appendix of your assignment and provide a brief interpretation of the results.
