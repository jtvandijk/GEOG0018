...
To get started, open your `GEOG0018` **R Project**. Create a new script. **File** -> **New File** -> **R Script**. Save your script as `w07-age-employment-analysis.r`. 
...
2. Apply the relevant test to compare the proportion of people *aged 50 years and over* across the boroughs of *Lambeth*, *Southwark*, and *Westminster*.
